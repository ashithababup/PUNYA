	...
	<body id="block_1">
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				<li> 
					...
					<ul>
						<li><a href="index.php">Manage Articles</a></li> <!-- Add class "current" to sub menu items also -->
						<li><a class="current" href="index_1.php">Manage Comments</a></li> 
					</ul>
				</li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="#messages" rel="modal"><span>
					<img src="resources/images/icons/tick_circle.png" alt="icon" /><br />
					Open Modal
				</span></a></li>
